...
int VP8DecoderImpl::Decode(const EncodedImage& input_image,
  ...
  WEBRTC_TRACE(webrtc::kTraceDebug, webrtc::kTraceVideoCoding, 9997,
               "VP8DecoderImpl::%s, input_image._encodedWidth = %d, input_image._encodedHeight = %d ", __FUNCTION__, input_image._encodedWidth, input_image._encodedHeight);
